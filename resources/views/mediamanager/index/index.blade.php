    ...
    <div id="component" class="component">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col px-3">
                    <div class="mmm-grid">
                        <div class="section section-t bg-light border rounded-top p-2 d-flex justify-content-between">
                        ...
                        <div v-if="loading && query.page === 1 && results.rows.length === 0" class="pt-2 text-center border border-top-0 rounded-bottom">
                            @component('elements.spinner') @endcomponent
                        </div>
                        <div v-cloak v-if="!loading && query.page === 1 && results.rows.length === 0" class="pt-2 text-center border border-top-0 rounded-bottom">
                            <div class="p-3">There are no files you are looking for.</div>
                        </div>
                        <div v-cloak v-if="(!loading || query.page > 1) && results.rows.length > 0" class="grid-wrapper pt-2 border border-top-0 rounded-bottom">
                            <div v-for="file in results.rows" class="card card-file">
                                <img class="card-img-top bg-checkered" v-bind:src="file.urls.thumbnail" width="100%" height="100%">
