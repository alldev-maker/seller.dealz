    ...
    <div class="container-fluid px-3">
        <div id="user" class="row">
            <div class="col">
                    ...
                    <div class="table-grid border rounded">
                        <div class="section section-t border-bottom rounded-top p-2 d-flex justify-content-between align-items-center">
                            ...
                            <div class="button-area ml-auto">
                                <a class="btn btn-labeled btn-primary" href="<?php echo route('admin.users.add'); ?>">
                            ...
                            <table class="table table-bordered table-hover bg-white mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr v-if="results.total.records > 0 && !loading" v-for="entity of results.rows">
                                        ...
                                        <td class="">@{{ entity.nice_name }}</td>
                                        <td class="role">@{{ entity.role.name }}</td>
                ...
                <!-- Delete Modal Start -->
                <div class="modal fade" id="entity-remove" tabindex="-1" user="dialog" aria-labelledby="entity-remove-title" aria-hidden="true">
                ...
                <div class="modal fade" id="entity-remove-selected" tabindex="-1" user="dialog" aria-labelledby="entity-remove-selected-title" aria-hidden="true">
                    <div class="modal-dialog modal-lg" user="document">
                        <div class="modal-content border-0">
...
@section('javascript')
    ...
    <script src="{{ asset('js/components/admin/users/index.js') }}"></script>
@endsection