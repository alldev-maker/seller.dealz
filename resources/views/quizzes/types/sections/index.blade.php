...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item active" aria-current="page">Section Types</li>
    </ol>
</nav>
                ...
                <div class="table-grid border rounded">
                    <div class="section section-t border-bottom rounded-top p-2 d-flex justify-content-between align-items-center">
                        ...
                        <div class="button-area ml-auto">
                            <a class="btn btn-labeled btn-primary" href="{{ route('quizzes.types.sections.add') }}">
...
@section('javascript')
<script>Message = @json($message); </script>
<script src="{{ asset('js/components/quizzes/types/sections/index.js') }}"></script>
@endsection