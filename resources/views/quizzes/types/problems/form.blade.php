...
<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        ...
        <li class="breadcrumb-item"><a href="{{ route('quizzes.types.problems.index')  }}">Problem Types</a></li>
        <li class="breadcrumb-item active" aria-current="page"><?php echo $problem->id > 0 ? 'Edit' : 'Add New'; ?></li>
    </ol>
</nav>
                                ...
                                <div class="card mb-3">
                                    ...
                                    <div class="card-body">
                                        <div class="form-group row">
                                            ...
                                            <div class="col">
                                                <input type="text" id="name" name="name" class="form-control"
                                                       ...
                                                       v-validate="'required'"
                                                       v-bind:class="{ 'is-invalid': errors.has('problem.name') }"
                                                >
                                                <div v-if="errors.has('problem.name')" class="invalid-feedback">Required</div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col">
                                                <textarea id="description" name="description" class="form-control" rows="7" v-model="problem.description"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group form-row mb-0">
                                            <label for="name" class="col-md-3 col-form-label">Visible to Summary</label>
                                            <div class="col">
                                                <switches v-model="problem.visibility" theme="bootstrap" color="primary" type-bold="true"></switches>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="modal-content border-0">
                        <form v-on:submit.prevent="remove">
                            ...
                            <div class="modal-body">
                                <p class="mb-0">Are you sure that you will delete the @{{ name.singular }} named <strong>@{{ problem.name }}</strong>?</p>
                            </div>
...
@section('javascript')
    <script>window.quizmaster.problemtype = @json($problem);</script>
    <script src="{{ asset('js/components/quizzes/types/problems/form.js') }}"></script>
@endsection