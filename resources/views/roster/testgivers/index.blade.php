...
@section('content')
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">Test Givers</li>
        </ol>
    </nav>
                    ...
                    <div class="table-grid border rounded">
                        <div class="section section-t border-bottom rounded-top p-2 d-flex justify-content-between align-items-center">
                            ...
                            <div class="button-area ml-auto d-flex">
                                ...
                                <a class="btn btn-labeled btn-primary" href="<?php echo route('roster.testgivers.add'); ?>">
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content border-0">
                            <form v-on:submit.prevent="remove">
                                ...
                                <div class="modal-body">
                                    <p class="mb-0">Are you sure that you will delete the @{{ name.singular }} named <strong>@{{ testgiver.name_full.western }}</strong>?</p>
                                </div>
                                <div class="modal-footer bg-light">
                                    <button type="button" class="btn btn-secondary btn-labeled" data-dismiss="modal">
...
@section('javascript')
    ...
    <script src="{{ asset('js/components/roster/testgivers/index.js') }}"></script>
@endsection