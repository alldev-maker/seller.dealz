...
new Vue({
  ...
  methods: {
    ...
    remove: function remove() {
      ...
      axios({
        method: 'DELETE',
        url: this.url.path.resource + '/' + this.type.id
      }).then(function () {
...
module.exports = __webpack_require__(/*! /home/james/Projects/GTC015 Quizmaster/resources/js/components/quizzes/types/problems/index.js */"./resources/js/components/quizzes/types/problems/index.js");
