  ...
  methods: {
    submit: function submit() {
      ...
      this.$validator.validateAll('type').then(function (result) {
        if (result) {
          axios({
            method: that.type.id !== '' ? 'PUT' : 'POST',
            url: that.url.path + (that.type.id !== '' ? '/' + that.type.id : ''),
            data: that.type
          }).then(function () {
...
module.exports = __webpack_require__(/*! /home/james/Projects/GTC015 Quizmaster/resources/js/components/quizzes/types/problems/form.js */"./resources/js/components/quizzes/types/problems/form.js");
