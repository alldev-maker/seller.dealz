...
/***/ "./resources/js/components/roster/testgivers/index.js":
/*!************************************************************!*\
  !*** ./resources/js/components/roster/testgivers/index.js ***!
  \************************************************************/
...
new Vue({
  ...
  data: {
    ...
    url: {
      path: {
        collection: '/roster/testgivers/list',
        resource: '/roster/testgivers'
      },
      qs: ''
    },
    loading: false,
  ...
  methods: {
    ...
    confirmRemove: function confirmRemove(testgiver) {
    ...
    remove: function remove() {
      ...
      axios({
        method: 'DELETE',
        url: this.url.path.resource + '/' + this.testgiver.id
      }).then(function () {
...
/***/ 13:
/*!******************************************************************!*\
  !*** multi ./resources/js/components/roster/testgivers/index.js ***!
  \******************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! /home/james/Projects/Web/GTC015 Quizmaster/resources/js/components/roster/testgivers/index.js */"./resources/js/components/roster/testgivers/index.js");
