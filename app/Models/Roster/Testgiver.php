 ...
 * @property User    $user
 *
 * @method static TestGiver find(int $id)
 * @method static TestGiver findOrFail(int $id)
 */
class Testgiver extends Model
{

    const PATH = 'roster.testgivers';
    const SLUG = 'testgiver';

    protected $table = 'roster_testgivers';
    ...
    {
        $role = SystemSetting::find('testgiver.role');
